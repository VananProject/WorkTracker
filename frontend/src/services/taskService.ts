...
//   dueDate?: Date | null; // Changed to match component state
// }
...
//     try {
//       const response = await taskAPI.startTask(taskData);
//       return response.data;
//     } catch (error) {
...
//   // Assign task to user
//   static async assignTask(taskData: AssignTaskData) {
//     try {
//       const apiData = this.convertAssignTaskToAPIFormat(taskData);
//       const response = await taskAPI.assignTask(apiData);
//       return response.data;
//     } catch (error) {
...
//   // Create task assignment (public endpoint)
//   static async createTaskAssignment(taskData: AssignTaskData) {
//     try {
//       const apiData = this.convertAssignTaskToAPIFormat(taskData);
//       const response = await taskAPI.createTaskAssignment(apiData);
//       return response.data;
//     } catch (error) {
...
//     try {
//       const response = await taskAPI.pauseTask(taskId, { elapsedTime });
//       return response.data;
//     } catch (error) {
...
//   // Resume task
//   static async resumeTask(taskId: string, elapsedTime: number) {
//     try {
...
//   // End task
//   static async endTask(taskId: string, elapsedTime: number) {
//     try {
//       const response = await taskAPI.endTask(taskId, { elapsedTime });
//       return response.data;
//     } catch (error) {
...
//   // Utility method to format task data for API
...
//   // Utility method to format assignment data for API
...
static async rejectTask(taskId: string, rejectedBy: string, reason?: string) {
  ...
  // Create task assignment (using createTaskAssignment endpoint)
  // static async createTaskAssignment(taskData: AssignTaskData) {
  //   try {
  //     console.log('🎯 TaskService.createTaskAssignment called with:', taskData);
  //     const apiData = this.convertAssignTaskToAPIFormat(taskData);
  //     const response = await taskAPI.createTaskAssignment(apiData);
  //     return response.data;
  //   } catch (error) {
  ...
  // static async endTask(taskId: string, elapsedTime: number) {
  //   try {
  //     console.log('🔄 TaskService.endTask:', { taskId, elapsedTime });
  //     const response = await taskAPI.endTask(taskId, { 
  //       elapsedTime,
