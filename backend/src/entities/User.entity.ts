...
export class User {
  ...
  constructor(data: Partial<User>) {
    ...
    // this.telegramVerified = data.telegramVerified || false;
    // this.telegramOtp = data.telegramOtp;
    // this.telegramOtpExpiry = data.telegramOtpExpiry;
    this.createdAt = data.createdAt;
    this.updatedAt = data.updatedAt;
  }
  ...
  //   return this.telegramVerified === true;
  // }
